...
#         from create_file_meta import create_file
#         create_file('/home/aeri/ant/dojo/pasta/team/work/, file_name.type)
        
#         Output Python codeblock that creates a file named test.py and prints Hello, PASTA
...
# create_file('/home/aeri/ant/dojo/pasta/team/work/', 'open_ai_output.py', prepass.choices[0].message.content)
file_path = '/home/aeri/ant/dojo/pasta/team/work/open_ai_output.py'
